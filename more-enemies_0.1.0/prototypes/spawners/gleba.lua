...
if (max_count_of_owned_defensive_units_small and max_count_of_owned_defensive_units_small.value) then
  data.raw["unit-spawner"]["gleba-spawner"].max_count_of_owned_defensive_units = max_count_of_owned_defensive_units_small.value
end
...
if (max_defensive_friends_around_to_spawn_small and max_defensive_friends_around_to_spawn_small.value) then
  data.raw["unit-spawner"]["gleba-spawner"].max_defensive_friends_around_to_spawn = max_defensive_friends_around_to_spawn_small.value
end
...
if (    max_spawning_cooldown_gleba_small
    and max_spawning_cooldown_gleba_small.value
    and min_spawning_cooldown_gleba_small
    and min_spawning_cooldown_gleba_small.value
  ) then
      data.raw["unit-spawner"]["gleba-spawner-small"].spawning_cooldown = {max_spawning_cooldown_gleba_small.value, min_spawning_cooldown_gleba_small.value}
end
