...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units_biter, Constants.nauvis.biter.MAX_COUNT_OF_OWNED_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units_biter, Constants.nauvis.biter.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn_biter, Constants.nauvis.biter.MAX_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn_biter, Constants.nauvis.biter.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_spawning_cooldown_biters, Constants.nauvis.biter.MAX_SPAWNING_COOLDOWN)
    and Settings_Validations.validate_setting_not_equal_to(min_spawning_cooldown_biters, Constants.nauvis.biter.MIN_SPAWNING_COOLDOWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units_spitter, Constants.nauvis.spitter.MAX_COUNT_OF_OWNED_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units_spitter, Constants.nauvis.spitter.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn_spitter, Constants.nauvis.spitter.MAX_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn_spitter, Constants.nauvis.spitter.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_spawning_cooldown_spitters, Constants.nauvis.spitter.MAX_SPAWNING_COOLDOWN)
    and Settings_Validations.validate_setting_not_equal_to(min_spawning_cooldown_spitters, Constants.nauvis.spitter.MIN_SPAWNING_COOLDOWN)) then
