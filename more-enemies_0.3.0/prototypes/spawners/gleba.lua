...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units_small, Constants.gleba.small.MAX_COUNT_OF_OWNED_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units_small, Constants.gleba.small.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn_small, Constants.gleba.small.MAX_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn_small, Constants.gleba.small.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_spawning_cooldown_gleba_small, Constants.gleba.regular.MAX_SPAWNING_COOLDOWN)
    and Settings_Validations.validate_setting_not_equal_to(max_spawning_cooldown_gleba_small, Constants.gleba.regular.MIN_SPAWNING_COOLDOWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units, Constants.gleba.regular.MAX_COUNT_OF_OWNED_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units, Constants.gleba.regular.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn, Constants.gleba.regular.MAX_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn, Constants.gleba.regular.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
...
if (Settings_Validations.validate_setting_not_equal_to(max_spawning_cooldown_gleba, Constants.gleba.regular.MAX_SPAWNING_COOLDOWN)
    and Settings_Validations.validate_setting_not_equal_to(min_spawning_cooldown_gleba, Constants.gleba.regular.MIN_SPAWNING_COOLDOWN)) then
