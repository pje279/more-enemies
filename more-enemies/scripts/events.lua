...
script.on_event(defines.events.script_raised_built, Spawn_Controller.entity_built, Spawn_Constants.filter)
...
script.on_event(defines.events.on_cargo_pod_finished_descending, Overmind_Controller.on_cargo_pod_finished_descending)
...
-- script.on_event(defines.events.on_post_entity_died, Overmind_Controller.on_post_entity_died, Spawn_Constants.filter)
script.on_event(defines.events.on_robot_built_entity, Overmind_Controller.on_robot_built_entity)
script.on_event(defines.events.on_robot_exploded_cliff, Overmind_Controller.on_robot_exploded_cliff)
