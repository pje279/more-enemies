...
if (data and data.raw and data.raw[unit_spawner] and data.raw[unit_spawner][spawner_name]) then
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units_small, Gleba_Constants.gleba.small.MAX_COUNT_OF_OWNED_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = max_count_of_owned_units_small.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = difficulty.small.max_count_of_owned_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units_small, Gleba_Constants.gleba.small.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = max_count_of_owned_defensive_units_small.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = difficulty.small.max_count_of_owned_defensive_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn_small, Gleba_Constants.gleba.small.MAX_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = max_friends_around_to_spawn_small.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = difficulty.small.max_friends_around_to_spawn
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn_small, Gleba_Constants.gleba.small.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = max_defensive_friends_around_to_spawn_small.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = difficulty.small.max_defensive_friends_around_to_spawn
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units, Gleba_Constants.gleba.regular.MAX_COUNT_OF_OWNED_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = max_count_of_owned_units.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = difficulty.regular.max_count_of_owned_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units, Gleba_Constants.gleba.regular.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = max_count_of_owned_defensive_units.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = difficulty.regular.max_count_of_owned_defensive_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn, Gleba_Constants.gleba.regular.MAX_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = max_friends_around_to_spawn.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = difficulty.regular.max_friends_around_to_spawn
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn, Gleba_Constants.gleba.regular.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = max_defensive_friends_around_to_spawn.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = difficulty.regular.max_defensive_friends_around_to_spawn
  end
