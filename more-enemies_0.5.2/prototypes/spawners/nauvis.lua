...
if (data and data.raw and data.raw[unit_spawner] and data.raw[unit_spawner][spawner_name]) then
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units_biter, Nauvis_Constants.nauvis.biter.MAX_COUNT_OF_OWNED_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = max_count_of_owned_units_biter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = difficulty.biter.max_count_of_owned_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units_biter, Nauvis_Constants.nauvis.biter.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = max_count_of_owned_defensive_units_biter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = difficulty.biter.max_count_of_owned_defensive_units
  end
  ...
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = difficulty.biter.max_friends_around_to_spawn
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn_biter, Nauvis_Constants.nauvis.biter.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = max_defensive_friends_around_to_spawn_biter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = difficulty.biter.max_defensive_friends_around_to_spawn
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_units_spitter, Nauvis_Constants.nauvis.spitter.MAX_COUNT_OF_OWNED_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = max_count_of_owned_units_spitter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_units = difficulty.spitter.max_count_of_owned_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_count_of_owned_defensive_units_spitter, Nauvis_Constants.nauvis.spitter.MAX_COUNT_OF_OWNED_DEFENSIVE_UNITS)) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = max_count_of_owned_defensive_units_spitter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_count_of_owned_defensive_units = difficulty.spitter.max_count_of_owned_defensive_units
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_friends_around_to_spawn_spitter, Nauvis_Constants.nauvis.spitter.MAX_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = max_friends_around_to_spawn_spitter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_friends_around_to_spawn = difficulty.spitter.max_friends_around_to_spawn
  end
  ...
  if (Settings_Validations.validate_setting_not_equal_to(max_defensive_friends_around_to_spawn_spitter, Nauvis_Constants.nauvis.spitter.MAX_DEFENSIVE_FRIENDS_AROUND_TO_SPAWN)) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = max_defensive_friends_around_to_spawn_spitter.value
  elseif (difficulty.valid) then
    data.raw[unit_spawner][spawner_name].max_defensive_friends_around_to_spawn = difficulty.spitter.max_defensive_friends_around_to_spawn
  end
